Hello! This react application was built using 'create-react-app'.
...
To run, please use 'npm start' on command prompt or powershell on the my-app folder. To view the application, navigate to http://localhost:3000/ afterwards.

As an aside, please use Chrome to view the app as I found that IE/Edge does not support my drag and drop application in last minute testing. Due to time constraints, I did not have the time to put in browser specific workarounds.

Thank you!

-Paul Kim

For addition information, default Readme is below:
